...
F7 "TX" O R 7475 3675 50 
F8 "RX" I R 7475 3750 50 
$EndSheet
$Sheet
S 3675 3950 900  325 
U 60435425
...
F0 "GSM" 50
F1 "SIM800L.sch" 50
F2 "RX" I R 7075 4400 50 
F3 "TX" O R 7075 4500 50 
F4 "RST" I R 7075 4300 50 
F5 "3,9V" I L 6225 4475 50 
$EndSheet
Wire Wire Line
	4575 4200 5550 4200
Wire Wire Line
...
U 1 1 60310B40
P 5975 4400
F 0 "#PWR07" H 5975 4250 50  0001 C CNN
F 1 "+3V8" H 5990 4573 50  0000 C CNN
...
Wire Wire Line
	3750 2675 3750 2850
$Comp
L SYSbee_mod-rescue:PWR_FLAG-power #FLG01
U 1 1 602F8959
P 2650 5050
...
$EndComp
$Comp
L SYSbee_mod-rescue:PWR_FLAG-power #FLG02
U 1 1 602F91B9
P 3425 5075
...
F 0 "#PWR0103" H 8700 4375 50  0001 C CNN
...
U 1 1 6041A1C9
P 8675 4150
AR Path="/6041A1C9" Ref="#PWR0104"  Part="1" 
AR Path="/60439374/6041A1C9" Ref="#PWR?"  Part="1" 
F 0 "#PWR0104" H 8675 4000 50  0001 C CNN
F 1 "+3V8" H 8690 4323 50  0000 C CNN
