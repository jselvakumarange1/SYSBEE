...
F 1 "10u" H 5510 1865 50  0000 L CNN
F 2 "Capacitor_Tantalum_SMD:CP_EIA-6032-15_Kemet-U" H 5433 1760 50  0001 C CNN
...
F 2 "Capacitor_Tantalum_SMD:CP_EIA-3528-21_Kemet-B" H 6733 1735 50  0001 C CNN
...
F 3 "" H 6010 2150 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text HLabel 4575 4400 0    50   Input ~ 0
GSM_SHDN
$Comp
...
U 1 1 602B463C
P 4725 1925
F 0 "D2" V 4679 2004 50  0000 L CNN
F 1 "D_Shockley" V 4770 2004 50  0000 L CNN
F 2 "Diode_SMD:D_SOD-123" H 4725 1925 50  0001 C CNN
...
U 1 1 602C0718
P 4725 2175
F 0 "#PWR013" H 4725 1925 50  0001 C CNN
...
F 1 "430" H 6368 4355 50  0000 L CNN
...
F 1 "200" H 6368 4680 50  0000 L CNN
...
Condensateur de 10uF 35V
$Comp
L Sysbee-rescue:SYSbee_mod-rescue_C-Device-SYSbee_mod-cache C11
U 1 1 602FE2F9
P 4775 4650
F 0 "C11" H 4660 4604 50  0000 R CNN
F 1 "10u" H 4660 4695 50  0000 R CNN
F 2 "Capacitor_Tantalum_SMD:CP_EIA-6032-15_Kemet-U" H 4813 4500 50  0001 C CNN
F 3 "" H 4775 4650 50  0001 C CNN
	1    4775 4650
	1    0    0    1   
$EndComp
Text Notes 6800 2050 0    50   ~ 0
Condensateur de 10uF 16V
Text Notes 4900 2500 0    50   ~ 0
Condensateur de 47uF 35V\n
$Comp
...
U 1 1 602C908F
P 6750 4525
F 0 "C12" H 6865 4571 50  0000 L CNN
F 1 "10u" H 6865 4480 50  0000 L CNN
F 2 "Capacitor_Tantalum_SMD:CP_EIA-3528-21_Kemet-B" H 6788 4375 50  0001 C CNN
...
On peut utiliser aussi un MIC37252 qui devrait permettre une tension d'entrée moins grande (5V)
Wire Wire Line
	4575 4400 5100 4400
Wire Wire Line
	4575 4200 4775 4200
